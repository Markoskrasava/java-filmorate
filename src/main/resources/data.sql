-- 1. Справочники (друзья, рейтинги, жанры)
-- friends_status
INSERT INTO friends_status (id, name) VALUES
                                          (1, 'IGNORED'),
                                          (2, 'ACCEPTED');

-- mpa_ratings (порядок должен совпадать с enum MpaRating: G=1, PG=2, PG_13=3, R=4, NC_17=5)
...
-- 3. Фильмы (mpa_rating_id берём из mpa_ratings выше)
